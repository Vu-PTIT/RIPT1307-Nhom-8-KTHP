...
const ipRoot = typeof APP_CONFIG_IP_ROOT !== 'undefined' && APP_CONFIG_IP_ROOT
...
const ipLibrary = typeof APP_CONFIG_LIBRARY_API !== 'undefined' && APP_CONFIG_LIBRARY_API
...
const keycloakAuthority = typeof APP_CONFIG_KEYCLOAK_AUTHORITY !== 'undefined' && APP_CONFIG_KEYCLOAK_AUTHORITY
	...
	: '';
const resourceServerClientId = `${(typeof APP_CONFIG_PREFIX_OF_KEYCLOAK_CLIENT_ID !== 'undefined' ? APP_CONFIG_PREFIX_OF_KEYCLOAK_CLIENT_ID : '')}auth`;
