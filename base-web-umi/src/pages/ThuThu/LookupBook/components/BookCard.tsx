...
const BookCard: React.FC<BookCardProps> = ({ book, onDetail }) => {
	...
	return (
		...
		>
			...
			{/* Tags Trạng thái - Chuẩn màu Figma */}
			<div style={{ marginBottom: 16, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
				<Tag color='#fff1f0' style={{ color: '#ff4d4f', borderColor: '#ffccc7', borderRadius: 4, fontWeight: 500 }}>
					{book.category}
				</Tag>
				...
				{isOutOfStock ? (
					...
					<Tag color='#f6ffed' style={{ color: '#52c41a', borderColor: '#b7eb8f', borderRadius: 4, fontWeight: 500 }}>
						{book.availableCount} bản khả dụng
					</Tag>
				)}
			</div>

			{/* Bộ nút hành động dưới đáy Card */}
